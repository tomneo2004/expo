...
function getWebviewSource(firebaseConfig, firebaseVersion, invisible) {
...
export default function FirebaseRecaptcha(props) {
    const { firebaseConfig, firebaseVersion, onVerify, onLoad, onError, onFullChallenge, invisible, verify, ...otherProps } = props;
    ...
    return (React.createElement(WebView, Object.assign({ ref: webview, javaScriptEnabled: true, automaticallyAdjustContentInsets: true, scalesPageToFit: true, mixedContentMode: "always", source: getWebviewSource(firebaseConfig, firebaseVersion, invisible), onError: onError, onMessage: event => {
